  ...
  return (
    <div className="w-full space-y-5 md:space-y-6 pt-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:space-x-6 space-y-10 md:space-y-0">
        {/* Get Started Button */}
        <a href="/getStarted" className="w-full">
          <button className="w-[240px] py-3 md:w-[30%] lg:w-[40%] 2xl:py-4 bg-green-gradient text-white rounded-full font-medium lg:text-md 2xl:text-lg hover:bg-green-700">
            Get Started
          </button>
        </a>
      </div>
