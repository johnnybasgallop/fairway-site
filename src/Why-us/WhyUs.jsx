...
const LeftColumn = () => {
  ...
  return (
    <div className="flex flex-col h-[630px] md:h-[350px] lg:h-[480px] 2xl:h-[580px] lg:gap-2 gap-5">
      {features.map((feature, index) => (
        ...
        >
          <div className="flex items-center lg:mb-4">
            {/* Icon Container */}
            <h4 className="text-xl lg:text-xl 2xl:text-[25px] font-medium">
              {feature.title}
            </h4>
          </div>
          <p className="text-md lg:text-[15px] 2xl:text-[19px] lg:pr-2 font-light pt-4 md:pt-2">
            {feature.description}
          </p>
        </div>
      ))}
...
const RightColumn = () => {
  ...
  return (
    <div className="flex flex-col h-[630px] md:h-[400px] lg:h-[480px] 2xl:h-[580px] lg:gap-2 gap-5">
      {features.map((feature, index) => (
        <div
          key={index}
          className={`py-6 flex flex-col justify-center lg:px-10 px-6 rounded-lg shadow-sm ${feature.bgColor} ${feature.textColor} ${feature.height}`}
