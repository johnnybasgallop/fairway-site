...
export default function HowItWorks() {
  return (
    <section className="px-[20px] md:px-[30px] lg:px-[40px] xl:px-[80px] py-12 bg-white text-left w-full lg:py-[60px] xl:py-[100px] 2xl:py-[120px]">
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-[50px] flex justify-between bg-gray-100 py-8 px-[50px] rounded-lg">
        {/* Basics Section */}
        ...
        <div className="w-[80%] flex flex-col">
          ...
          <div className="space-y-6 border-gray-300">
            {/* Data Tracking */}
