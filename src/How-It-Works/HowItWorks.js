      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-[50px] flex bg-gray-50 py-8 px-[20px] md:px-[30px] rounded-lg">
        ...
        <div className="flex flex-2 flex-col">
          ...
          <div className=" space-y-2 md:space-y-0 flex flex-col justify-center border-gray-300 pb-5">
            {/* Data Tracking */}
            <div className="flex items-start justify-between py-5 border-b border-gray-300 bg-gray-100 md:bg-gray-50 hover:bg-gray-200 px-4 rounded-md">
              <div className="flex flex-col justify-center mb-4">
                <h3 className="font-bold max-w-[90%] py-2">
              ...
              <div className="w-10 h-10 flex items-center justify-center bg-purple-200 rounded-lg mt-2">
                <FaSearch className="text-purple-600 text-xl" />
              </div>
            </div>

            {/* What Goes Into a Trade */}
            <div className="flex items-start justify-between py-7 border-b border-gray-300 bg-gray-100 md:bg-gray-50 hover:bg-gray-200 px-4 rounded-md">
              <div className="flex flex-col items-start justify-start mb-2">
                <h3 className="font-bold">What goes into a trade</h3>
                <p className="text-gray-500 text-sm">Discover our process</p>
              </div>
              <div className="w-10 h-10 flex items-center justify-center bg-blue-200 rounded-lg mt-2">
            ...
            <div className="flex items-start justify-between py-7 border-b border-gray-300 bg-gray-100 md:bg-gray-50 hover:bg-gray-200 px-4 rounded-md">
              ...
              <div className="w-10 h-10 flex items-center justify-center bg-green-200 rounded-lg mt-2">
